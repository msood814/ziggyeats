...
class Overview extends React.Component {
  ...
  render() {
    // console.log(this.props.restaurantData, "ob")
                  ...
                  <tbody >
                    <tr>
                      <td>
                        ...
                        {/* <span className="text text-dark text-justify" style={{ fontSize: "15px" }}><strong> Cuisines : </strong>North indian, Chinese, Pizza</span><br /> */}
...
class Menu extends React.Component {
  constructor(props) {
    ...
    // this.tempCart = this.state.cart
    // this.tempPrice = this.state.price
    // this.props.menu.map(item => {
    //   this.state.tempCart[item.dishName] = 0;
    //   this.state.tempPrice[item.dishName] = 0;
    //   return null
    // });
    // this.setState({ cart: this.tempCart, price: this.tempPrice })
  ...
  placeOrder = () => {
    let f = 0
    this.props.menu.map(item => {
      // console.log(this.state.cart[item.dishName])
                    ...
                    return (
                      <tr key={item.dishName} style={{ paddingTop: 60, textTransform: 'capitalize' }}>
                        ...
                        {/* <td className="text align-middle">
                          {item.available ? <span>Yes</span> : <span>No</span>}
                        </td> */}
                        <td>
...
class AddReview extends React.Component {
  ...
  valdiateAddReview = event => {
    ...
    if (!localStorage.getItem('admin')) {
      this.setState({
        addReviewErrorMessage: 'You are not logged in'
      })
    }
    else if (event.target.value.length < 5) {
      this.setState({
        addReviewSuccessMessage: "",
        addReviewErrorMessage: "Review should consist of atleast 5 characters",
        validateAddReview: false
      });
    } else {
      this.setState({
        addReviewErrorMessage: "",
        validateAddReview: true,
  ...
  addReview = () => {
    ...
    axios
      .post(
        "http://localhost:1050/restaurant/insertReview/" + this.props.restaurantName,
        reviewObj
      )
      .then(response => {
        this.setState({
          addReviewSuccessMessage: response.data.message
        });
      })
      .catch(err => {
        if (err) {
          this.setState({
            addReviewErrorMessage: err.response.data.message,
            addReviewSuccessMessage: ""
          });
        } else {
          this.setState({
            addReviewErrorMessage: "server error",
            addReviewSuccessMessage: ""
          });
        }
      });
...
export class TabViewDemo extends Component {
  ...
  render() {
    // console.log("this.state", this.props.restaurantData);
    return (
      <div>
...
class ShowRate extends React.Component {
  ...
  giveRating = event => {
    ...
    //console.log("sasas");
    axios
      .post("http://localhost:1050/restaurant/giveRating/" + this.props.restaurantName, ratingObj).then(response => {
          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <div className="col-md-4" style={{ paddingRight: "40px" }}>
                ...
                {/* 
                            {(this.state.sideviewRestaurantByCat.length>=2)?<h4 className="text-muted">More restaurants in {this.state.sideviewRestaurantByCat[0].category} </h4>:null}
                            {(this.state.sideviewRestaurantByCat.length>=2 && !this.props.customerId)?<div className="card-columns">
                               <Link to={'/restaurant/'+ this.state.sideviewRestaurantByCat[0].location + '/' + this.state.sideviewRestaurantByCat[0].restaurantName } onClick={()=>{this.setState({clicked:true})}}>  <div className="card bg-light" style={{height:"160px"}}>
                                    <img alt="" className="card-img-top" src={require('../assets/' + this.state.sideviewRestaurantByCat[0].location + '/' + this.state.sideviewRestaurantByCat[0].restaurantName + '.jpg')} height="65%"/>
                                    <p style={{marginBottom:"0px"}}><span style={{fontSize: "2vh", paddingLeft:"2px"}} className="text-muted"><strong>{this.state.sideviewRestaurantByCat[0].restaurantName}</strong></span><br/>
                                    <span style={{fontSize: "2vh", paddingLeft:"2px"}} className="text-muted">{this.state.sideviewRestaurantByCat[0].category}</span></p>
                                </div> </Link>
<Link to={'/restaurant/'+ this.state.sideviewRestaurantByCat[1].location + '/' + this.state.sideviewRestaurantByCat[1].restaurantName } onClick={()=>{this.setState({clicked:true})}}> <div className="card bg-light" style={{height:"160px"}}>
                                    <img alt="" className="card-img-top" src={require('../assets/' + this.state.sideviewRestaurantByCat[1].location + '/' + this.state.sideviewRestaurantByCat[1].restaurantName + '.jpg')} height="65%"/>
                                    <p><span style={{fontSize: "2vh", paddingLeft:"2px"}} className="text-muted"><strong>{this.state.sideviewRestaurantByCat[1].restaurantName}</strong></span><br/>
                                    <span style={{fontSize: "2vh", paddingLeft:"2px"}} className="text-muted">{this.state.sideviewRestaurantByCat[1].category}</span></p>
                                </div> </Link>
<Link to={'/restaurant/'+ this.state.sideviewRestaurantByCat[2].location + '/' + this.state.sideviewRestaurantByCat[2].restaurantName } onClick={()=>{this.setState({clicked:true})}}> <div className="card bg-light" style={{height:"160px"}}>
                                    <img alt="" className="card-img-top" src={require('../assets/' + this.state.sideviewRestaurantByCat[2].location + '/' + this.state.sideviewRestaurantByCat[2].restaurantName + '.jpg')} height="65%"/>
                                    <p><span style={{fontSize: "2vh", paddingLeft:"2px"}} className="text-muted"><strong>{this.state.sideviewRestaurantByCat[2].restaurantName}</strong></span><br/>
                                    <span style={{fontSize: "2vh", paddingLeft:"2px"}} className="text-muted">{this.state.sideviewRestaurantByCat[2].category}</span></p>
                                </div> </Link>
                                </div>:(this.state.sideviewRestaurantByCat.length>=2 && this.props.customerId)?<div className="card-columns"><Link to={'/restaurant/'+ this.state.sideviewRestaurantByCat[0].location + '/' + this.state.sideviewRestaurantByCat[0].restaurantName + '/' + this.props.customerId + '/' + this.props.name } onClick={()=>{this.setState({clicked:true})}}>  <div className="card bg-light" style={{height:"160px"}}>
                                    <img alt="" className="card-img-top" src={require('../assets/' + this.state.sideviewRestaurantByCat[0].location + '/' + this.state.sideviewRestaurantByCat[0].restaurantName + '.jpg')} height="65%"/>
                                    <p style={{marginBottom:"0px"}}><span style={{fontSize: "2vh", paddingLeft:"2px"}} className="text-muted"><strong>{this.state.sideviewRestaurantByCat[0].restaurantName}</strong></span><br/>
                                    <span style={{fontSize: "2vh", paddingLeft:"2px"}} className="text-muted">{this.state.sideviewRestaurantByCat[0].category}</span></p>
                                </div> </Link>
                                <Link to={'/restaurant/'+ this.state.sideviewRestaurantByCat[1].location + '/' + this.state.sideviewRestaurantByCat[1].restaurantName + '/' + this.props.customerId + '/' + this.props.name } onClick={()=>{this.setState({clicked:true})}}>  <div className="card bg-light" style={{height:"160px"}}>
                                    <img alt="" className="card-img-top" src={require('../assets/' + this.state.sideviewRestaurantByCat[1].location + '/' + this.state.sideviewRestaurantByCat[1].restaurantName + '.jpg')} height="65%"/>
                                    <p><span style={{fontSize: "2vh", paddingLeft:"2px"}} className="text-muted"><strong>{this.state.sideviewRestaurantByCat[1].restaurantName}</strong></span><br/>
                                    <span style={{fontSize: "2vh", paddingLeft:"2px"}} className="text-muted">{this.state.sideviewRestaurantByCat[1].category}</span></p>
                                </div> </Link>
                                <Link to={'/restaurant/'+ this.state.sideviewRestaurantByCat[2].location + '/' + this.state.sideviewRestaurantByCat[2].restaurantName + '/' + this.props.customerId + '/' + this.props.name } onClick={()=>{this.setState({clicked:true})}}>  <div className="card bg-light" style={{height:"160px"}}>
                                    <img alt="" className="card-img-top" src={require('../assets/' + this.state.sideviewRestaurantByCat[2].location + '/' + this.state.sideviewRestaurantByCat[2].restaurantName + '.jpg')} height="65%"/>
                                    <p><span style={{fontSize: "2vh", paddingLeft:"2px"}} className="text-muted"><strong>{this.state.sideviewRestaurantByCat[2].restaurantName}</strong></span><br/>
                                    <span style={{fontSize: "2vh", paddingLeft:"2px"}} className="text-muted">{this.state.sideviewRestaurantByCat[2].category}</span></p>
                                </div> </Link>
